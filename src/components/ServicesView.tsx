...
import { StickyStackCard, FadeIn } from './MotionComponents';
...
export default function ServicesView({ onBackToHome, onNavigateToContact }: ServicesViewProps) {
  ...
  return (
    <div className="bg-background min-h-screen text-on-background pb-24 mt-20">
      ...
      <div className="flex flex-col gap-12 py-16 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">

        {/* Service 1: Consulenza per Nuove Aperture e Start-up */}
        <StickyStackCard index={0} totalCards={3}>
          <section className="bg-surface-container py-16 px-6 md:px-16 rounded-3xl border border-outline/10 shadow-xl w-full">
              ...
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-6 space-y-6 order-2 lg:order-1">
                  ...
                  <p className="font-body-lg text-on-surface-variant leading-relaxed">
                    Metto a disposition la mia esperienza decennale nel settore per supportare chi desidera aprire o rilanciare un'attività di gastronomia o ristorazione. Ti assisto in ogni fase decisionale per creare una struttura resiliente e competitiva.
                  </p>
                  ...
                  <div className="space-y-4 pt-4 border-t border-outline/10">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-secondary text-sm">Organizzazione operativa, dalla selezione dei fornitori (privilegliando il km zero e i piccoli produttori) alla progettazione del layout funzionale della cucina.</p>
                      </div>
                    </div>
        ...
        <StickyStackCard index={1} totalCards={3}>
          <section className="bg-surface-container py-16 px-6 md:px-16 rounded-3xl border border-outline/10 shadow-xl w-full">
            <div className="w-full">
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                {/* Visual Column */}
        ...
        <StickyStackCard index={2} totalCards={3}>
          <section className="bg-surface-container py-16 px-6 md:px-16 rounded-3xl border border-outline/10 shadow-xl w-full">
            <div className="w-full">
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                {/* Copy Column first on desktop for alternation */}
